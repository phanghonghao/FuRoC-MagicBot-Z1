...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_grid": terrain_gen.MeshRandomGridTerrainCfg(proportion=0.3, grid_width=0.6, grid_height_range=(0.0, 0.4)),
    },
)
@configclass
...
class RewardsCfg:
    ...
    joint_deviation_hip_knee = RewTerm(func=mdp.joint_deviation_l1, weight=-0.8, params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_pitch_joint", ".*_knee_joint"])})

...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "random_grid": terrain_gen.MeshRandomGridTerrainCfg(proportion=0.3, grid_width=0.6, grid_height_range=(0.0, 0.5)),
    },
)
...
class RewardsCfg:
    ...
    base_height = RewTerm(func=mdp.base_height_l2, weight=-10.0, params={"target_height": 0.7})
